                  ...
                  {!formSubmitted ? (
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        <Button 
                          type="submit" 
                          className="w-full bg-learnup-blue1 hover:bg-learnup-blue4 text-white transition-colors"
                        >
                          Send Message
                        </Button>
                      </div>
                ...
                <div>
                  ...
                  <div className="space-y-8">
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-learnup-blue3 rounded-full flex items-center justify-center mr-4">
                        <Mail className="h-5 w-5 text-learnup-blue1" />
                      </div>
                      <div>
                        <h3 className="font-semibold text-gray-800">Email Us</h3>
                        <p className="text-gray-600 mt-1">
                          <a href="mailto:info@learnup.com" className="text-learnup-blue1 hover:underline">
                            info@learnup.com
                          </a>
                        </p>
                        <p className="text-gray-600 mt-1">
                          <a href="mailto:support@learnup.com" className="text-learnup-blue1 hover:underline">
                            support@learnup.com
                          </a>
                        </p>
                      </div>
                    ...
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-learnup-blue3 rounded-full flex items-center justify-center mr-4">
                        <Phone className="h-5 w-5 text-learnup-blue1" />
                      </div>
                      <div>
                        <h3 className="font-semibold text-gray-800">Call Us</h3>
                        <p className="text-gray-600 mt-1">
                          <a href="tel:+11234567890" className="text-learnup-blue1 hover:underline">
                            +1 (123) 456-7890
                          </a>
                        </p>
                    ...
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-learnup-blue3 rounded-full flex items-center justify-center mr-4">
                        <MapPin className="h-5 w-5 text-learnup-blue1" />
                      </div>
                      <div>
                    ...
                    <div className="flex items-start">
                      <div className="w-10 h-10 bg-learnup-blue3 rounded-full flex items-center justify-center mr-4">
                        <Clock className="h-5 w-5 text-learnup-blue1" />
                      </div>
                      <div>
